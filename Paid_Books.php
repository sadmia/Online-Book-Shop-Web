									...
									<div class="row">
										...
										<div class="col-md-8 col-sm-12">
											...
											<ul class="BAB-list">
												...
												<a href="Paid_Books.php"><li class="active-BG">Paid Books</li></a>
											</ul>
							...
							<div class="contante-list">
								...
								<div class="row justify-content-center">
									...
									<?php 
										...
										$selectAllData = "SELECT `id`, `bookTitle`, `bookDisk`, `bookPrice`, `reting`, `favourite`, `pdfName`, `coverImg`, `view` FROM `book` WHERE bookPrice != 0 ORDER BY reting DESC";
