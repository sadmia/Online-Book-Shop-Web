								...
								<div class="header-bottom-site">
									...
									<div class="row">
										...
										<div class="col-md-8 col-sm-12">
											...
											<ul class="BAB-list">
												<a href="index.php"><li class="active-BG">All Book</li></a>
												<a href="Most_Recent.php"><li>Most Recent</li></a>
										...
										<!-- <div class="col-md-4 col-sm-12">
											...
											<div class="keybord-div">
												...
												<form class="search">
													<input type="text" name="Keybord" placeholder="Enter Keybords">
							...
							<div class="contante-list">
								...
								<div class="row justify-content-center">
									...
									<?php 
										...
										$selectAllData = "SELECT `id`, `bookTitle`, `bookDisk`, `bookPrice`, `reting`, `favourite`, `pdfName`, `coverImg`, `view` FROM `book` WHERE privacy = 0 ORDER BY reting DESC";
