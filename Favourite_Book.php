					...
					<div class="col-lg-2 col-md-3 col-sm-4 con-padd-0">
						...
						<div class="left-align-site">
							...
							<div class="manu-nav-list">
								<ul>
									<a href="index.php"><li><i class="fas fa-globe-americas"></i> Browse</li></a>
									<a href="Favourite_Book.php"><li  class="active-LAS"><i class="fas fa-star"></i> Favourite Book</li></a>
								</ul>
							</div>
							...
							<div class="contante-list">
								...
								<div class="row justify-content-center">
									...
									<?php 
										...
										$selectAllData = "SELECT `id`, `bookTitle`, `bookDisk`, `bookPrice`, `reting`, `favourite`, `pdfName`, `coverImg`, `view` FROM `book` WHERE favourite = 1 ORDER BY reting DESC";
