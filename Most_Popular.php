									...
									<div class="row">
										...
										<div class="col-md-8 col-sm-12">
											...
											<ul class="BAB-list">
												...
												<a href="Most_Popular.php"><li class="active-BG">Most Popular</li></a>
							...
							<div class="contante-list">
								...
								<div class="row justify-content-center">
									...
									<?php 
										...
										$selectAllData = "SELECT `id`, `bookTitle`, `bookDisk`, `bookPrice`, `reting`, `favourite`, `pdfName`, `coverImg`, `view` FROM `book` ORDER BY view DESC LIMIT 10";
